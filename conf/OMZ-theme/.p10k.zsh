# Generated by Powerlevel10k configuration wizard on 2020-12-14 at 23:45 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX='%93F╭─'
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX='%93F├─'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%93F╰─'
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=219 #default:39
  ...
  ###############################[ public_ip: public IP address ]###############################
  # Public IP color.
  typeset -g POWERLEVEL9K_PUBLIC_IP_FOREGROUND=178 #default 94
  # Custom icon.
